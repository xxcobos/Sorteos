...
@Component({
  selector: 'app-show-futuro',
  templateUrl: './show-futuro.component.html',
  styleUrls: ['./show-futuro.component.css']
})
export class ShowFuturoComponent implements OnInit {
  ...
  initializeWheel() {
    const colors = ['#00BFBF', '#00CED1', '#3A3F45', '#009999', '#2B2E33'];
